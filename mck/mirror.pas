...
begin
  ...
  begin
    ...
    begin
      s := Old[ I ];
      if StrIsStartingFrom( PKOLChar( s ), ' PROC(2) //--by PCompiler:line#' ) then // TODO: dangerous
        Old[ I ] := ' PROC(2)'
      else
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if S_Upper = '{$IFDEF KOL_MCK}' then
          if StrIsStartingFrom( PKOLChar(UpperCase( Trim( Source[ I + 2 ] ) )),
    ...
    begin
      ...
      begin
        ...
        if StrIsStartingFrom( PKOLChar( S ), '{$I MCKFAKECLASSES.INC}' ) then
        begin
